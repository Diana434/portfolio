...
5. BI (яндекс.Даталенс)
   ...
   4.2 - [Дашборд с анализом конференций TED](https://datalens.yandex/4a0zhatt8wy6p)
...
Файлы pandas -- файлы, связанные с python - библиотеками pandas и matplotlib

Файлы homework -- файлы, связанные с заданиями на машинное обучение и морфосинтаксический парсинг
